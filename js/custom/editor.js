...
jQuery().ready(function() {
		jQuery('textarea.tinymce').tinymce({
			...
			theme_advanced_buttons2 : "pastetext,pasteword,|,bullist,numlist,|,undo,redo,|,link,unlink,image,帮助,code,|,preview,|,forecolor,backcolor,removeformat,|,charmap,media,|,fullscreen",
